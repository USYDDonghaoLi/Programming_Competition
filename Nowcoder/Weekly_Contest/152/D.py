...
def solve(testcase):
    ...
    A = []
    A.append(Point(sx, sy))
    A.append(Point(sx + k, sy))
    A.append(Point(sx, sy + k))
    A.append(Point(sx + k, sy + k))

    A.append(Point(tx, ty))
    A.append(Point(tx + k, ty))
    A.append(Point(tx, ty + k))
    A.append(Point(tx + k, ty + k))
