...
def solve(testcase):
    ...
    def calc(X, Y):
        ...
        T_min = max(T_min, (1 - X + b // g - 1) // (b // g))
        T_max = min(T_max, (n - X) // (b // g))
        # print('T1', T_min, T_max)
        T_max = min(T_max, (1 - Y) // (-a // g))
        T_min = max(T_min, (n - Y - a // g + 1) // (-a // g))
        # print('T_info', T_min, T_max)
    ...
    for i in range(1, n + 1):
        ...
        if t < a + b:
            ...
            mul = t // g
            res += calc(x * mul, y * mul)
            # print(x * mul, y * mul, a * x * mul + b * y * mul == t)
            # print('need_sol', a, b, t, calc(x * mul, y * mul))
