...
def solve(testcase):
    ...
    have = [False for _ in range(15)]
    for num in nums:
        for bit in range(15):
            if num >> bit & 1:
                have[bit] = True
    
    idxs = [i for i in range(15) if have[i]]
    m = len(idxs)
    ...
    '''
    sub
    1: (5, 7), (5, 7, 4), (5, 7, 6), (5, 7, 4, 6)
    2: (4, 6), (4, 6, 5), (4, 6, 7), (4, 6, 7, 5)
    4: (4), (4, 5), (4, 6), (4, 7), (4, 5, 6), (4, 5, 7), (4, 6, 7), (4, 5, 6, 7)
    add
    3: (3, 7), (3, 7, 4), (3, 7, 6), (3, 7, 4, 6)
    5: (5, 7), (5, 7, 4), (5, 7, 6), (5, 7, 4, 6)
    6: (6), 
    '''
    ...
    for i in range(1, 1 << m):
        ...
        for j in range(m):
            if i >> j & 1:
                tmp |= 1 << idxs[j]  
                cnt += 1
        print('tmpcnt', tmp, cnt)
        
        choice = 0
        for num in nums:
            if tmp | num == num:
                choice += 1
        print('tmpchoice', tmp, choice)
